...
const comparison_agent_1 = require("./comparison.agent");
let ComparisonService = ComparisonService_1 = class ComparisonService {
    constructor(comparisonAgent) {
        this.comparisonAgent = comparisonAgent;
        this.logger = new common_1.Logger(ComparisonService_1.name);
    }
...
exports.ComparisonService = ComparisonService = ComparisonService_1 = __decorate([
    ...
    __metadata("design:paramtypes", [comparison_agent_1.ComparisonAgent])
], ComparisonService);
